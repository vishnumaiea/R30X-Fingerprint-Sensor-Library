...
Fingerprint_VMA fps = Fingerprint_VMA (&Serial1, 0x16161616, 0x16161616); //custom password and address
// Fingerprint_VMA fps = Fingerprint_VMA (&Serial1); //use deafault password and address
